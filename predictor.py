...
class PSSPredictor:
    ...
    def create_model(self):
        ...
        model.compile(optimizer='adam', loss='categorical_crossentropy', metrics=['accuracy', 'mae', q3_score])
    ...
    def load_model(filepath='model.keras'):
        ...
        loaded_model = tf.keras.models.load_model(filepath, custom_objects={"q3_score": q3_score})
